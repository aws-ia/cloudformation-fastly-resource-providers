...
1. Write the JSON schema describing your resource, [fastly-tls-privatekeys.json](./fastly-tls-privatekeys.json)
2. Implement your resource handlers in [handlers.ts](./fastly-tls-privatekeys/handlers.ts)

> Don't modify [models.ts](./fastly-tls-privatekeys/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
