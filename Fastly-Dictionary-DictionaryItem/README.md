...
This resource type manages a [Fastly Dictionary Item][3]
...
1. Write the JSON schema describing your resource, [fastly-dictionary-dictionaryitem.json](./fastly-dictionary-dictionaryitem.json)
2. Implement your resource handlers in [handlers.ts](./fastly-dictionary-dictionaryitem/handlers.ts)

> Don't modify [models.ts](./fastly-dictionary-dictionaryitem/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
...
[3]: https://docs.fastly.com/en/guides/working-with-dictionaries-using-the-web-interface#creating-a-dictionary-item
[4]: ./docs/README.md
