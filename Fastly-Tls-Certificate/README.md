...
1. Write the JSON schema describing your resource, [fastly-tls-certificate.json](./fastly-tls-certificate.json)
2. Implement your resource handlers in [handlers.ts](./fastly-tls-certificate/handlers.ts)

> Don't modify [models.ts](./fastly-tls-certificate/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
