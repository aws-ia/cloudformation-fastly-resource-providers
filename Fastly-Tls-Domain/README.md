...
1. Write the JSON schema describing your resource, [fastly-tls-domain.json](./fastly-tls-domain.json)
2. Implement your resource handlers in [handlers.ts](./fastly-tls-domain/handlers.ts)

> Don't modify [models.ts](./fastly-tls-domain/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
