...
This resource type manages a [Fastly Dictionary][3]
...
1. Write the JSON schema describing your resource, [fastly-dictionary-dictionary.json](./fastly-dictionary-dictionary.json)
2. Implement your resource handlers in [handlers.ts](./fastly-dictionary-dictionary/handlers.ts)

> Don't modify [models.ts](./fastly-dictionary-dictionary/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
