...
export class ResourceModel extends BaseModel {
    ...
    @Transform(
        (value: any, obj: any) =>
            transformValue(String, 'hostname', value, obj, []),
        {
            toClassOnly: true,
        }
    )
...
export class Backend extends BaseModel {
    ['constructor']: typeof Backend;
    ...
    sslClientKey?: Optional<string>;
    @Expose({ name: 'SslHostname' })
    @Transform(
        (value: any, obj: any) =>
            transformValue(String, 'sslHostname', value, obj, []),
        {
            toClassOnly: true,
        }
    )
