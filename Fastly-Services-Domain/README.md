...
This resource type manages a [Fastly Service Domain][3]
...
### Shows how to create a Domain in Fastly
```yaml
---
...
1. Write the JSON schema describing your resource, [fastly-services-Domain.json](./fastly-services-domain.json)
2. Implement your resource handlers in [handlers.ts](./fastly-services-Domain/handlers.ts)

> Don't modify [models.ts](./fastly-services-Domain/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
...
[3]: https://docs.fastly.com/en/guides/working-with-domains
[4]: ./docs/README.md
